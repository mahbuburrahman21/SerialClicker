...
// #include <ESP32Servo.h> // CHANGED: Servo library is no longer needed
...
// Servo myServo; // CHANGED: Servo object removed
const int ledPin = 15; // CHANGED: Pin variable renamed for clarity (still GPIO 15)
...
// The HTML and JavaScript for the GUI
const char index_html[] PROGMEM = R"rawliteral(
<!DOCTYPE HTML>
<html>
<head>
  <title>ESP32 Wi-Fi Control</title> <!-- CHANGED: Title updated -->
...
<body>
  <h1>ESP32 LED Blink Control</h1> <!-- CHANGED: Header updated -->
  <div class="container">
    ...
    <div class="input-group">
      <label for="clicks">Number of Blinks:</label> <!-- CHANGED: Label updated -->
...
void setup() {
  ...
  // CHANGED: Setup the pin for the LED
  ...
  if (isRunning && !isPaused) {
    if (millis() - lastClickTime >= clickDelay) {
      if (clicksDone < numberOfClicks) {
        ...
        // CHANGED: Perform the 'blink' action
        ...
        // CHANGED: Status message updated for clarity
        String status = "Blinks: " + String(clicksDone) + "/" + String(numberOfClicks);
