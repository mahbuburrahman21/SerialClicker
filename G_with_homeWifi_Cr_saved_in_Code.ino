...
// HTML Page is unchanged, so it is omitted here for brevity. 
// You can use the exact same HTML content as the previous code.
...
void setup() {
  ...
  Serial.println(WiFi.localIP()); // This is the address you will use
  // -----------------------------
  ...
  // WebSocket Event Handler (This part remains the same)
